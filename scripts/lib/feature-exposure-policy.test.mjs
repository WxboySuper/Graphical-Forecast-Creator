/**
 * Script test contract for feature-exposure-policy.test.
 *
 * This file verifies the script or automation boundary represented by feature-exposure-policy.test, including its inputs, outputs, and failure behavior.
 */
