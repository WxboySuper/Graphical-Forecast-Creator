...
describe('AuthProvider Utils', () => {
  ...
  test('hands off an active subscription and swallows late rejections', async () => {
    const unsubscribe = jest.fn();
    const setSubscription = jest.fn();
    ...
    const rejectedUnsubscribe = jest.fn();
    await expect(
    ...
    expect(rejectedUnsubscribe).not.toHaveBeenCalled();
