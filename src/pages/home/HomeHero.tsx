...
const HeroLeftPanel: React.FC<Pick<Props, 'onStart' | 'onWriteDiscussion'>> = ({ onStart, onWriteDiscussion }) => (
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/10 via-primary/5 to-background border border-primary/20 p-10 md:p-14">
      ...
      <div className="relative flex flex-col md:flex-row items-start md:items-center gap-8">
        <HeroLeftPanel onStart={onStart} onWriteDiscussion={onWriteDiscussion} />
