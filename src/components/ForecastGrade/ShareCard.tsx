...
const SHARE_BUTTON_CLASS =
  'fg-touch inline-flex items-center gap-2 rounded-lg border border-slate-300/50 px-3 py-2 text-sm disabled:opacity-50';
    ...
    <div className="fg-section">
      <div className="fg-section-body pt-4">
        ...
        <div className="flex flex-wrap gap-2">
          <button type="button" className={SHARE_BUTTON_CLASS} onClick={handleDownload} disabled={busy}>
            <Download className="h-4 w-4" /> Download
          </button>
          <button type="button" className={SHARE_BUTTON_CLASS} onClick={handleShare} disabled={busy}>
            <Share2 className="h-4 w-4" /> Share
          </button>
          <button type="button" className={SHARE_BUTTON_CLASS} onClick={handleCopy} disabled={busy}>
