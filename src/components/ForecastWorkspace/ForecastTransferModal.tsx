/**
 * File: src/components/ForecastWorkspace/ForecastTransferModal.tsx
 * Purpose: Renders forecast transfer controls and coordinates import/export transfer actions.
 */
