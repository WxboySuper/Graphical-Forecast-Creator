...
- **@types/node** ^26.1.2 (root (pnpm)) — MIT — allowed
...
- **firebase** ^12.17.1 (root (pnpm)) — Apache-2.0 — allowed
- **firebase-tools** 15.26.0 (root (pnpm)) — MIT — allowed
...
- **ol-mapbox-style** ^13.4.2 (root (pnpm)) — BSD-2-Clause — allowed
