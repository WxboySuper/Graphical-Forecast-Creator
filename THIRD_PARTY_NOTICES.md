...
- **@babel/core** ^8.0.5 (root (pnpm)) — MIT — allowed
- **@babel/parser** ^8.0.5 (root (pnpm)) — MIT — allowed
- **@babel/preset-env** ^8.0.5 (root (pnpm)) — MIT — allowed
...
- **@playwright/test** ^1.63.0 (root (pnpm)) — Apache-2.0 — allowed
...
- **@sentry/react** ^10.74.0 (root (pnpm)) — MIT — allowed
...
- **@testing-library/user-event** ^14.6.7 (root (pnpm)) — MIT — allowed
...
- **@types/node** ^26.5.1 (root (pnpm)) — MIT — allowed
...
- **autoprefixer** ^10.5.6 (root (pnpm)) — MIT — allowed
- **babel-jest** ^30.5.1 (root (pnpm)) — MIT — allowed
...
- **jest** ^30.5.1 (root (pnpm)) — MIT — allowed
- **jest-environment-jsdom** ^30.5.1 (root (pnpm)) — MIT — allowed
- **jszip** ^3.10.2 (root (pnpm)) — (MIT OR GPL-3.0-or-later) — allowed
- **lucide-react** ^1.45.0 (root (pnpm)) — ISC — allowed
...
- **stripe** ^22.6.2 (server (npm)) — MIT — allowed
