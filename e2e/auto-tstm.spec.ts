...
// Auto-TSTM is exposed on every v1.7 release build target (see src/config/featureExposure.ts).
// The capability mock keeps this workflow testable without requiring live cached guidance.
